...
class TransactionServiceTest {
    ...
    void createTransactionCase1() throws Exception {
        ...
        verify(notificationService, times(1)).sendNotification(sender, "Transaction success");
        verify(notificationService, times(1)).sendNotification(receiver, "Transaction success");
    }

    @Test
    @DisplayName("Should throw Exception when Transaction is not allowed")
    void createTransactionCase2() throws Exception {
        User sender = new User(1L, "Maria", "Souza", "99999999901", "maria@gmail.com", "12345", new BigDecimal(10), UserType.MERCHANT);
        User receiver = new User(2L, "Joao", "Souza", "99999999902", "joao@gmail.com", "12345", new BigDecimal(10), UserType.COMMON);
